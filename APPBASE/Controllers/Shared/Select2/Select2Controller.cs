...
namespace APPBASE.Controllers
{
    ...
    public partial class Select2ajaxController : Controller
    {
        ...
        [HttpGet]
        public JsonResult getClassroom_BACKUP(string q, string psFilter1, string psFilter2, string psFilter3)
        {
            int? nFilter1 = null;
            if ((psFilter1 != null) && (psFilter1 != "")) nFilter1 = Convert.ToInt32(psFilter1);
            ...
            Select2VM data = new ClassroomDS().getDatalist_select2ajax(q, nFilter1);
