...
{
    public partial class SkhstudenthController : Controller
    {
        [HttpPost]
        public ActionResult Create(SkhstudenthdetailVM poViewModel)
        {

            oVAL = new Skhstudenth_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(SkhstudenthdetailVM poViewModel)
        {
            oVAL = new Skhstudenth_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class SkhstudenthController : Controller
