...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(ClassroomteacherdetailVM poViewModel)
        {
            ViewBag.AC_MENU_ID = valMENU.PENGATURAN_CLASSROOMTEACHER_CREATE;

            oVAL = new Classroomteacher_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(ClassroomteacherdetailVM poViewModel)
        {
