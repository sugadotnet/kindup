...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Index(SkmVM poViewModel)
        {
            ViewBag.AC_MENU_ID = valMENU.AKADEMIK_SKM_INDEX;

            oVAL = new Skm_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Create(SkmVM poViewModel)
        {
            ViewBag.AC_MENU_ID = valMENU.AKADEMIK_SKM_CREATE;

            oVAL = new Skm_Validation(poViewModel.DETAIL);
        ...
        [HttpPost]
        public ActionResult Edit(SkmVM poViewModel)
        {
