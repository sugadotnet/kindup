...
namespace APPBASE.Controllers
{
    public partial class LookupController : Controller
    {
        ...
        EvaluationDS oDSEvaluation = new EvaluationDS();
        public ActionResult ShowEvaluation(List<string> paSearchValue, List<string> paTargetTag)
        {
            //TODO: Buat Access Control untuk lookup tertentu/Pilih Akses kontrol yang pas dari menu
            //hlpSecurity.CredentialInfo.isValidAccessMenu(MNURUID_CCS_INPUT_PJX_REG);
            ...
            ViewBag.CODE_TAG = paTargetTag[1];
            ViewBag.DESC_TAG = paTargetTag[2];
            return View(oDSEvaluation.getDatalist_lookup());
        } //End public ActionResult ShowEvaluation
        ThemeDS oDSTheme = new ThemeDS();
        public ActionResult ShowTheme(List<string> paSearchValue, List<string> paTargetTag)
        {
            //TODO: Buat Access Control untuk lookup tertentu/Pilih Akses kontrol yang pas dari menu
            //hlpSecurity.CredentialInfo.isValidAccessMenu(MNURUID_CCS_INPUT_PJX_REG);
            ...
            ViewBag.CODE_TAG = paTargetTag[1];
            ViewBag.DESC_TAG = paTargetTag[2];
            return View(oDSTheme.getDatalist_lookup());
        } //End public ActionResult ShowTheme
        RateDS oDSRate = new RateDS();
        public ActionResult ShowRate(List<string> paSearchValue, List<string> paTargetTag)
        {
            //TODO: Buat Access Control untuk lookup tertentu/Pilih Akses kontrol yang pas dari menu
            //hlpSecurity.CredentialInfo.isValidAccessMenu(MNURUID_CCS_INPUT_PJX_REG);
            ...
            ViewBag.CODE_TAG = paTargetTag[1];
            ViewBag.DESC_TAG = paTargetTag[2];
            return View(oDSRate.getDatalist_lookup());
        } //End public ActionResult ShowRate

        SkhDS oDSSkh = new SkhDS();
        public ActionResult ShowSkh(List<string> paSearchValue, List<string> paTargetTag)
        {
            //TODO: Buat Access Control untuk lookup tertentu/Pilih Akses kontrol yang pas dari menu
            //hlpSecurity.CredentialInfo.isValidAccessMenu(MNURUID_CCS_INPUT_PJX_REG);
            ...
            return View(oDSSkh.getDatalist_lookup());
        } //End public ActionResult ShowSkh
        ...
        public ActionResult ShowStudent(List<string> paSearchValue, List<string> paTargetTag)
        {
            ...
            ViewBag.DESC_TAG = paTargetTag[2];
            ViewBag.OTHER_TAG = paTargetTag[3];
            return View(oDSStudent.getDatalist_lookup());
