...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(AnnouncementdetailVM poViewModel)
        {
            ViewBag.AC_MENU_ID = valMENU.AKADEMIK_PENGUMUMAN_CREATE;

            oVAL = new Announcement_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(AnnouncementdetailVM poViewModel)
        {
