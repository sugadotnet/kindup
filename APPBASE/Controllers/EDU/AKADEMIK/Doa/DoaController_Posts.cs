...
{
    public partial class DoaController : Controller
    {
        [HttpPost]
        public ActionResult Create(DoadetailVM poViewModel)
        {

            oVAL = new Doa_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(DoadetailVM poViewModel)
        {
            oVAL = new Doa_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class DoaController : Controller
