...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(BasicmaterialdetailVM poViewModel)
        {
            ViewBag.AC_MENU_ID = valMENU.AKADEMIK_MATERIDASAR_CREATE;

            oVAL = new Basicmaterial_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(BasicmaterialdetailVM poViewModel)
        {
