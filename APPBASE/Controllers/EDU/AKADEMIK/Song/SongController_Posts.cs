...
{
    public partial class SongController : Controller
    {
        [HttpPost]
        public ActionResult Create(SongdetailVM poViewModel)
        {

            oVAL = new Song_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(SongdetailVM poViewModel)
        {
            oVAL = new Song_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class SongController : Controller
