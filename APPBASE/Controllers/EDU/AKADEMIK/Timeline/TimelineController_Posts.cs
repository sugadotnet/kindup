...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(TimelinedetailVM poViewModel)
        {

            oVAL = new Timeline_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(TimelinedetailVM poViewModel)
        {
            oVAL = new Timeline_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class TimelineController : Controller
