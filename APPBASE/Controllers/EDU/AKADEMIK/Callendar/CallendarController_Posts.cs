...
namespace APPBASE.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult Create(CallendardetailVM poViewModel)
        {
            ViewBag.AC_MENU_ID = valMENU.AKADEMIK_KALENDER_CREATE;

            oVAL = new Callendar_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(CallendardetailVM poViewModel)
        {
