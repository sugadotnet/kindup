...
{
    public partial class SkhstudentdController : Controller
    {
        [HttpPost]
        public ActionResult Create(SkhstudentddetailVM poViewModel)
        {

            oVAL = new Skhstudentd_Validation(poViewModel);
        ...
        [HttpPost]
        public ActionResult Edit(SkhstudentddetailVM poViewModel)
        {
            oVAL = new Skhstudentd_Validation(poViewModel);
            oVAL.Validate_Edit();
    ...
    } //End public partial class SkhstudentdController : Controller
