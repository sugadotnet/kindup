...
namespace APPBASE.Controllers
{
    ...
    public partial class StudentController : Controller
    {
        ...
        //DATA
        protected StudentdetailVM oData;
        protected List<StudentlistitemVM> oData_list;
        //VM
        protected StudentVM oFilter;
        //DS CFG
        ...
        public ActionResult Index_calon()
        {
            ViewBag.AC_MENU_ID = valMENU.TATAUSAHA_SISWA_INDEX;
            ViewBag.CRUDSavedOrDelete = TempData["CRUDSavedOrDelete"];
            ViewBag.CRUDAction = TempData["CRUDAction"];
        ...
        public ActionResult Index_alumni()
        {
            ViewBag.AC_MENU_ID = valMENU.TATAUSAHA_SISWA_INDEX;
            ViewBag.CRUDSavedOrDelete = TempData["CRUDSavedOrDelete"];
            ViewBag.CRUDAction = TempData["CRUDAction"];
        ...
        public ActionResult Index_pindah()
        {
            ViewBag.AC_MENU_ID = valMENU.TATAUSAHA_SISWA_INDEX;
            ViewBag.CRUDSavedOrDelete = TempData["CRUDSavedOrDelete"];
            ViewBag.CRUDAction = TempData["CRUDAction"];
        ...
        public ActionResult Index_alumni_details(int? id = null)
        {
            if (id != hlpConfig.SessionInfo.getAppResId())
            {
                ViewBag.AC_MENU_ID = valMENU.TATAUSAHA_SISWA_DETAILS;
        ...
        public ActionResult Index_pindah_details(int? id = null)
        {
            if (id != hlpConfig.SessionInfo.getAppResId())
            {
                ViewBag.AC_MENU_ID = valMENU.TATAUSAHA_SISWA_DETAILS;
        ...
        public ActionResult Classmate()
        {
            ...
            var oData = oDS.getDatalist_classmate(hlpConfig.SessionInfo.getAppResId());
            prepareLookupFilter();
            return View(oData);
        }
