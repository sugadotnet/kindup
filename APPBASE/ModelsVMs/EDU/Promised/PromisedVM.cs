...
{
    public partial class PromisedVM : FilterdataVM
    {
        public List<PromisedlistitemVM> LIST { get; set; }
        public PromiseddetailVM DETAIL { get; set; }
    } //End public partial class PromisedVM
    public partial class PromisedlistitemVM
    {
        ...
        //public List<PromisedlistitemVM> Promised { get; set; }

        public int? ID { get; set; }
        public int? THEME_ID { get; set; }
        public string THEME_DESC { get; set; }
        public string SUBTHEME { get; set; }
    } //End public partial class PromisedlistitemVM
    public partial class PromiseddetailVM
    {
        public int? ID { get; set; }
        ...
        public string THEME_DESC { get; set; }
    } //End public partial class PromiseddetailVM

    public partial class PromisedlookupVM
    {
        public int? ID { get; set; }
        public string THEME_DESC { get; set; }
        public string SUBTHEME { get; set; }
    } //End public partial class PromisedlistVM
