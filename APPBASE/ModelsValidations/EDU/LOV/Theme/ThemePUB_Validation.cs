...
{
    public partial class Theme_Validation
    {
        private ThemedetailVM oViewModel;
        private ThemeDS oDS = new ThemeDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Theme_Validation(ThemedetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Theme_Validation()
    ...
    } //End public partial class Theme_Validation
