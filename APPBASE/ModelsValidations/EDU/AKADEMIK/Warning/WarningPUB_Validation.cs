...
{
    public partial class Warning_Validation
    {
        private WarningdetailVM oViewModel;
        private WarningDS oDS = new WarningDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Warning_Validation(WarningdetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Warning_Validation()
    ...
    } //End public partial class Warning_Validation
