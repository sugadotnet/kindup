...
{
    public partial class Callendar_Validation
    {
        private CallendardetailVM oViewModel;
        private CallendarDS oDS = new CallendarDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Callendar_Validation(CallendardetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Callendar_Validation()
    ...
    } //End public partial class Callendar_Validation
