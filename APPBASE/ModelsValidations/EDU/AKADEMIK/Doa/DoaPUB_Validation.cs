...
{
    public partial class Doa_Validation
    {
        private DoadetailVM oViewModel;
        private DoaDS oDS = new DoaDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Doa_Validation(DoadetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Doa_Validation()
    ...
    } //End public partial class Doa_Validation
