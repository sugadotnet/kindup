...
{
    public partial class Suggest_Validation
    {
        private SuggestdetailVM oViewModel;
        private SuggestDS oDS = new SuggestDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Suggest_Validation(SuggestdetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Suggest_Validation()
    ...
    } //End public partial class Suggest_Validation
