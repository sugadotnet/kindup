...
{
    public partial class Song_Validation
    {
        private SongdetailVM oViewModel;
        private SongDS oDS = new SongDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Song_Validation(SongdetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Song_Validation()
    ...
    } //End public partial class Song_Validation
