...
{
    public partial class Announcement_Validation
    {
        private AnnouncementdetailVM oViewModel;
        private AnnouncementDS oDS = new AnnouncementDS();
        public List<ValidationMSG_VM> aValidationMSG = new List<ValidationMSG_VM>();

        //Constructor
        public Announcement_Validation(AnnouncementdetailVM poViewModel)
        {
            oViewModel = poViewModel;
        } //End public Announcement_Validation()
    ...
    } //End public partial class Announcement_Validation
